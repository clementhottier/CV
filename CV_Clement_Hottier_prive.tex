...
\begin{cvtable}
  ...
  \cvitem{2016-2020}{Stage d'observation OHP}{Observatoire de Paris/Univ Paris-Saclay}
  {- Encadrement d'observation sur instruments professionnels\\
   - Développement de la boite à outil de réduction des données et distribution en package
...
\subsection{Conférences International}
\begin{cvtable}
  \cvitem{Avril 2019}
