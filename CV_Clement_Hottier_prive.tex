...
\begin{cvtable}
  \cvitem{2021-}{Post-Doctorant}{Observatoire de Paris}{- Conception d'algorithme de
  tomographie 3D}
  \cvitem{2019-2020}{Enseignant Chercheur (ATER)}{Observatoire de Paris}{- Exploration
    ...
    - Big Data (Python, Java, SQL)\\
    - Mise a disposition de base de données (SQL, ADQL, Fits)\\
    - Administration de données non réduite (HDF5)\\
    - Implémentation d'algorithme de classification et création de catalogues (Python)
    }
    \cvitem{2016-2019}{Doctorant (Avec mission d'enseignement)}{Observatoire de Paris}{
      - Conception, optimisation, et validation d'un algorithme d'analyse par déconvolution Bayésienne (Java)\\
    - Implémentation et Intégration continue d'un logiciel d'analyse de données (Git et
    GitLab CI)\\
    - Gestion d'un logiciel d'analyse (Java) en mode production dans un centre de calcul ($\approx
  200\.000$hCPU) et des résultats brut ($10$TB)\\
  - Développement du Pipeline de post processing et de visualisation (Python)
